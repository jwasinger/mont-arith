...
func SubMod512(out_bytes, x_bytes, y_bytes, modulus []byte) error {
	x := (*[8]uint64)(unsafe.Pointer(&x_bytes[0]))[:]
	y := (*[8]uint64)(unsafe.Pointer(&y_bytes[0]))[:]
	out := (*[8]uint64)(unsafe.Pointer(&out_bytes[0]))[:]
	mod := (*[8]uint64)(unsafe.Pointer(&modulus[0]))[:]

	submod512(out, x, y, mod)
	return nil
}

func AddMod512(out_bytes, x_bytes, y_bytes, modulus []byte) error {
	x := (*[8]uint64)(unsafe.Pointer(&x_bytes[0]))[:]
	y := (*[8]uint64)(unsafe.Pointer(&y_bytes[0]))[:]
	out := (*[8]uint64)(unsafe.Pointer(&out_bytes[0]))[:]
	mod := (*[8]uint64)(unsafe.Pointer(&modulus[0]))[:]

	addmod512(out, x, y, mod)
	return nil
}

func MulModMont512(out_bytes, x_bytes, y_bytes, modulus []byte, modinv uint64) error {
	x := (*[8]uint64)(unsafe.Pointer(&x_bytes[0]))[:]
	y := (*[8]uint64)(unsafe.Pointer(&y_bytes[0]))[:]
	out := (*[8]uint64)(unsafe.Pointer(&out_bytes[0]))[:]
	mod := (*[8]uint64)(unsafe.Pointer(&modulus[0]))[:]

	return mulmodMont512(out, x, y, mod, modinv)
}
...
func mulmodMont512(z, x, y, mod []uint64, modinv uint64) error {
	var t [8]uint64
	var c [8]uint64
...
func addmod512(z, x, y, mod []uint64) {
	var c uint64
...
func submod512(z, x, y, mod []uint64) {
	var c, c1 uint64
	tmp := [8]uint64{0, 0, 0, 0, 0, 0, 0, 0}
