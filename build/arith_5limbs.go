...
func SubMod320(out_bytes, x_bytes, y_bytes, modulus []byte) error {
	x := (*[5]uint64)(unsafe.Pointer(&x_bytes[0]))[:]
	y := (*[5]uint64)(unsafe.Pointer(&y_bytes[0]))[:]
	out := (*[5]uint64)(unsafe.Pointer(&out_bytes[0]))[:]
	mod := (*[5]uint64)(unsafe.Pointer(&modulus[0]))[:]

	submod320(out, x, y, mod)
	return nil
}

func AddMod320(out_bytes, x_bytes, y_bytes, modulus []byte) error {
	x := (*[5]uint64)(unsafe.Pointer(&x_bytes[0]))[:]
	y := (*[5]uint64)(unsafe.Pointer(&y_bytes[0]))[:]
	out := (*[5]uint64)(unsafe.Pointer(&out_bytes[0]))[:]
	mod := (*[5]uint64)(unsafe.Pointer(&modulus[0]))[:]

	addmod320(out, x, y, mod)
	return nil
}

func MulModMont320(out_bytes, x_bytes, y_bytes, modulus []byte, modinv uint64) error {
	x := (*[5]uint64)(unsafe.Pointer(&x_bytes[0]))[:]
	y := (*[5]uint64)(unsafe.Pointer(&y_bytes[0]))[:]
	out := (*[5]uint64)(unsafe.Pointer(&out_bytes[0]))[:]
	mod := (*[5]uint64)(unsafe.Pointer(&modulus[0]))[:]

	return mulmodMont320(out, x, y, mod, modinv)
}
...
func mulmodMont320(z, x, y, mod []uint64, modinv uint64) error {
	var t [5]uint64
	var c [5]uint64
...
func addmod320(z, x, y, mod []uint64) {
	var c uint64
...
func submod320(z, x, y, mod []uint64) {
	var c, c1 uint64
	tmp := [5]uint64{0, 0, 0, 0, 0}
