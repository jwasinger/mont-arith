...
func AddMod8192(out_bytes, x_bytes, y_bytes []byte, ctx *MontArithContext) error {
	...
	if x[127] >= mod[127] || y[127] >= mod[127] {
	...
	z[89], c = bits.Add64(x[89], y[89], c)
	z[90], c = bits.Add64(x[90], y[90], c)
	z[91], c = bits.Add64(x[91], y[91], c)
	z[92], c = bits.Add64(x[92], y[92], c)
	z[93], c = bits.Add64(x[93], y[93], c)
	z[94], c = bits.Add64(x[94], y[94], c)
	z[95], c = bits.Add64(x[95], y[95], c)
	z[96], c = bits.Add64(x[96], y[96], c)
	z[97], c = bits.Add64(x[97], y[97], c)
	z[98], c = bits.Add64(x[98], y[98], c)
	z[99], c = bits.Add64(x[99], y[99], c)
	z[100], c = bits.Add64(x[100], y[100], c)
	z[101], c = bits.Add64(x[101], y[101], c)
	z[102], c = bits.Add64(x[102], y[102], c)
	z[103], c = bits.Add64(x[103], y[103], c)
	z[104], c = bits.Add64(x[104], y[104], c)
	z[105], c = bits.Add64(x[105], y[105], c)
	z[106], c = bits.Add64(x[106], y[106], c)
	z[107], c = bits.Add64(x[107], y[107], c)
	z[108], c = bits.Add64(x[108], y[108], c)
	z[109], c = bits.Add64(x[109], y[109], c)
	z[110], c = bits.Add64(x[110], y[110], c)
	z[111], c = bits.Add64(x[111], y[111], c)
	z[112], c = bits.Add64(x[112], y[112], c)
	z[113], c = bits.Add64(x[113], y[113], c)
	z[114], c = bits.Add64(x[114], y[114], c)
	z[115], c = bits.Add64(x[115], y[115], c)
	z[116], c = bits.Add64(x[116], y[116], c)
	z[117], c = bits.Add64(x[117], y[117], c)
	z[118], c = bits.Add64(x[118], y[118], c)
	z[119], c = bits.Add64(x[119], y[119], c)
	z[120], c = bits.Add64(x[120], y[120], c)
	z[121], c = bits.Add64(x[121], y[121], c)
	z[122], c = bits.Add64(x[122], y[122], c)
	z[123], c = bits.Add64(x[123], y[123], c)
	z[124], c = bits.Add64(x[124], y[124], c)
	z[125], c = bits.Add64(x[125], y[125], c)
	z[126], c = bits.Add64(x[126], y[126], c)
	z[127], c = bits.Add64(x[127], y[127], c)
	...
	tmp[89], c = bits.Sub64(tmp[89], mod[89], c)
	tmp[90], c = bits.Sub64(tmp[90], mod[90], c)
	tmp[91], c = bits.Sub64(tmp[91], mod[91], c)
	tmp[92], c = bits.Sub64(tmp[92], mod[92], c)
	tmp[93], c = bits.Sub64(tmp[93], mod[93], c)
	tmp[94], c = bits.Sub64(tmp[94], mod[94], c)
	tmp[95], c = bits.Sub64(tmp[95], mod[95], c)
	tmp[96], c = bits.Sub64(tmp[96], mod[96], c)
	tmp[97], c = bits.Sub64(tmp[97], mod[97], c)
	tmp[98], c = bits.Sub64(tmp[98], mod[98], c)
	tmp[99], c = bits.Sub64(tmp[99], mod[99], c)
	tmp[100], c = bits.Sub64(tmp[100], mod[100], c)
	tmp[101], c = bits.Sub64(tmp[101], mod[101], c)
	tmp[102], c = bits.Sub64(tmp[102], mod[102], c)
	tmp[103], c = bits.Sub64(tmp[103], mod[103], c)
	tmp[104], c = bits.Sub64(tmp[104], mod[104], c)
	tmp[105], c = bits.Sub64(tmp[105], mod[105], c)
	tmp[106], c = bits.Sub64(tmp[106], mod[106], c)
	tmp[107], c = bits.Sub64(tmp[107], mod[107], c)
	tmp[108], c = bits.Sub64(tmp[108], mod[108], c)
	tmp[109], c = bits.Sub64(tmp[109], mod[109], c)
	tmp[110], c = bits.Sub64(tmp[110], mod[110], c)
	tmp[111], c = bits.Sub64(tmp[111], mod[111], c)
	tmp[112], c = bits.Sub64(tmp[112], mod[112], c)
	tmp[113], c = bits.Sub64(tmp[113], mod[113], c)
	tmp[114], c = bits.Sub64(tmp[114], mod[114], c)
	tmp[115], c = bits.Sub64(tmp[115], mod[115], c)
	tmp[116], c = bits.Sub64(tmp[116], mod[116], c)
	tmp[117], c = bits.Sub64(tmp[117], mod[117], c)
	tmp[118], c = bits.Sub64(tmp[118], mod[118], c)
	tmp[119], c = bits.Sub64(tmp[119], mod[119], c)
	tmp[120], c = bits.Sub64(tmp[120], mod[120], c)
	tmp[121], c = bits.Sub64(tmp[121], mod[121], c)
	tmp[122], c = bits.Sub64(tmp[122], mod[122], c)
	tmp[123], c = bits.Sub64(tmp[123], mod[123], c)
	tmp[124], c = bits.Sub64(tmp[124], mod[124], c)
	tmp[125], c = bits.Sub64(tmp[125], mod[125], c)
	tmp[126], c = bits.Sub64(tmp[126], mod[126], c)
	tmp[127], c = bits.Sub64(tmp[127], mod[127], c)
